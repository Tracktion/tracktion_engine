/*******************************************************************************
 ...
 BEGIN_JUCE_PIP_METADATA
  ...
  name:             tracktion_graph_TestRunner
  version:          0.0.1
  vendor:           Tracktion
  ...
  defines:          ENABLE_EXPERIMENTAL_TRACKTION_GRAPH=1, TRACKTION_UNIT_TESTS=1, JUCE_MODAL_LOOPS_PERMITTED=1

  type:             Console
  mainClass:        tracktion_graph_TestRunner
...
int main (int argv, char** argc)
{
    ...
    return TestRunner::runTests (junitFile, "tracktion_graph");
}
