...
namespace tracktion::inline engine
{
    ...
    TEST_SUITE ("tracktion_engine")
    {
        ...
        //                                           + static_cast<FrameCount> (inputLatencyNumSamples + outputLatencyNumSamples + blockNumFrames);
        ...
        //
        //     CHECK_EQ (squareBuffer.getNumSamples(), recordedFileBuffer.getNumSamples());
        //     CHECK (graph::test_utilities::buffersAreEqual (toBufferView (recordedFileBuffer).fromFrame (blockNumFrames),
        //                                                    toBufferView (squareBuffer).fromFrame (blockNumFrames),
        //                                                    juce::Decibels::decibelsToGain (-99.0f)));
        // }
