...
- Rendering
  ...
  - Renders no longer spin forever on a clip whose source file is missing: the wait for sources is bounded by `Renderer::Parameters::sourceReadyTimeout` and fails with an error
- Analysis
